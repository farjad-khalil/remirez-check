  ...
  return (
    <footer className="bg-darkGray text-white pt-12">
      <div className="container mx-auto px-4">
        {/* Desktop Layout */}
        <div className="hidden md:grid md:grid-cols-3 gap-8 mb-8 custom-1170:px-40">
          <div className="px-0">
          ...
          <div className="px-0" onClick={() => router.push('/services')}>
          ...
          <div className="px-0">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center">
                ...
                <Link href={`tel:${footer_contact.phone}`}>(516) 270-7024</Link>
              </li>
              <li className="flex items-center gap-2 min-w-0">
                <Mail className="w-5 h-5 flex-shrink-0 text-neonGreen" />
                <Link href={`mailto:${footer_contact.mail}`} className="truncate">
                  {footer_contact.mail}
                </Link>
              </li>
