  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-start justify-center gap-4 ">
        ...
        <motion.div
          className={`w-full md:w-1/2  order-1  ${isEven ? 'md:order-2' : 'md:order-1'}`}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
        >
          ...
          {/* Features List */}
          <div
            className={`mt-1 xl:space-y-4 px-4 ${isEven ? 'md:pr-0' : 'md:pl-0 '}   md:px-10 md:text-lg space-y-0  `}
          >
            {[
              { h: h1, d: desc_1 },
              { h: h2, d: desc_2 },
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-neutral-700 text-base max-[1200px]:text-sm">{d}</p>
                </div>
              </motion.div>
            ))}
            ...
            >
              {isEven ? (
                <ButtonGreen text={'Book Service'} to={'/contact'} />
              ) : (
                <ButtonLight text={'Book Service'} to={'/contact'} />
              )}
            </motion.div>
          </div>
        </motion.div>
