      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          {services_data.map((service, index) => (
            <div
              key={index}
              className={`flex-shrink-0 w-[280px] p-6 rounded-sm shadow-md snap-center ${
                index === mobileActiveIndex ? 'bg-neonGreen text-white' : 'bg-white'
              }`}
            >
              <div className="flex justify-center mb-4">
                <div className="relative w-16 h-16">
              ...
              <p
                className={`text-center ${index === mobileActiveIndex ? 'text-white' : 'text-gray-600'}`}
              >
                {service.description}
              </p>
            </div>
          ...
          {services_data.map((_, index) => (
            <div
              ...
              className={`h-2 rounded-full transition-all ${
                index === mobileActiveIndex ? 'w-6 bg-neonGreen' : 'w-2 bg-gray-300'
              }`}
              onClick={() => {
